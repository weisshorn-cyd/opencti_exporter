...
- Collect metrics by entity types and creators
- Update docker compose for opencti latest

## [v0.6.0] - 2026-04-10

### Changed

- Update to go 1.26.1 and dependencies
- Update github actions
- Update docker compose for opencti >=7
